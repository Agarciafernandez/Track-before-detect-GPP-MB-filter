%We run Calidad_lmb_pos_pp_sin_rao_mcmc_birth_superpos.m in Nell's scenario
%for known birth locations
...
%This scenario considers the uninformative birth scenario. This version does
...
%Mean in the center of the area with high uncertainty
...
%Define variables of the particle filter
Ntargets_max=17;
Nparticles=10000;
T_sq_cluster=200^2; %Threshold for performing the clustering (currently set very large)
...
%save('GPP_MB_PF_uninformative_results')
